{
  ...
  dimensions : {
    ...
    _time : {
      timeframes : [ "hour", "day", "week", "month", "year", "dayOfMonth", "dayOfWeek" ],
      type : "timestamp",
      column : "_time",
      reportOptions : {
        formatNumbers : true
    ...
    timestamp : {
      timeframes : [ "hour", "day", "week", "month", "year", "hourOfDay", "weekOfYear", "dayOfWeek" ],
      type : "timestamp",
      column : "timestamp",
      reportOptions : {
        formatNumbers : true
